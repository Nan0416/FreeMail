...
import { authErrors } from '../../src/auth/errors.js';
import { ACCESS_COOKIE, REFRESH_COOKIE } from '../../src/auth/cookies.js';
import { handler } from '../../src/handlers/rest.js';
...
vi.mock('../../src/email/create-read-service.js', () => ({
...
vi.mock('../../src/email/create-download-service.js', () => ({
